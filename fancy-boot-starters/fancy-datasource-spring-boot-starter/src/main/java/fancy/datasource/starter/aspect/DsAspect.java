package fancy.datasource.starter.aspect;

import fancy.datasource.starter.annotation.Ds;
import fancy.datasource.starter.context.DataSourceContextHolder;
...
public class DsAspect {
    ...
    @Around("@within(fancy.datasource.starter.annotation.Ds) || @annotation(fancy.datasource.starter.annotation.Ds)")
